...
def send_email(to, content):
    ...
    server.login("zaidsaiyed791@gmail.com", "")
    server.sendmail("zaidsaiyed791@gmail.com", to, content)
    server.close()
...
while True:
    ...
    try:
        ...
        if call(text):
            ...
            if "date" in text or "day" in text or "month" in text:
            ...
            elif "what is the weather in" in text or 'what is the temperature in' in text:
                key = "566758c9a9a7f527c33e00be8dcef23c"
                ...
                if js["cod"] != "404":
                    ...
                    weatherResponse = " The temperature in Celcius is " + str("%.2f" % temperature) + " The humidity is " + str(
                ...
                speak = speak + "I was created by section A8 4 Group"
                ...
                if "chrome" in text.lower():
                    ...
                    os.startfile(
                        r"C:\\Users\\zaids\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
                    )
                ...
                url = (
                   "https://newsapi.org/v2/top-headlines?country=us&apiKey=5b1cd0c98cbf4b0b96b075098cb0a040"
                )
